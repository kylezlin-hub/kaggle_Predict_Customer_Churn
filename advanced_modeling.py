...
def feature_engineering(df):
    ...
    # Binning Tenure
    df['tenure_group'] = pd.cut(df['tenure'], bins=[0, 12, 24, 36, 48, 60, 72, 100], labels=['0-12', '13-24', '25-36', '37-48', '49-60', '61-72', '73+'])
...
sub_path = 'c:/kaggle_Predict_Customer_Churn/submission_advanced.csv'
